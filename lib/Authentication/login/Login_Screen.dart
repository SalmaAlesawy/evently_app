              ...
              child: Column(
                ...
                children: [
                  provider.themeMode == ThemeMode.light
                      ...
                      : Assets.images.darkEventlyLogo
                          .image(width: 142, height: 27),
                  const SizedBox(
                    height: 30,
                  ),
                  Text(
                    ...
                    style: provider.themeMode == ThemeMode.light
                        ...
                        : textTheme.headlineSmall
                            ?.copyWith(color: DarkColorPalette.white),
                  ),
                  const SizedBox(
                    height: 30,
                  ),
                        ...
                        FireBaseAuthUtils.signInWithEmailAndPassword(
                          ...
                          if (value) {
                            ...
                            Navigator.pushReplacementNamed(
                                context, PageRouteName.layoutScreen);
                          }
                        });
                      }
                    },
                  ...
                  Customelevatedbutton(
                    ...
                    forGroundColor: WidgetStatePropertyAll(
                        provider.themeMode == ThemeMode.light
                            ? LightColorPalette.lightMainColor
                            : DarkColorPalette.darkMainColor),
                  )
